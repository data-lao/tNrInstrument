# Description ############################################################################################
#This R script was written to quickly process and finalize collected tNr data from the instrument 
...
# O = original measurements and date times 
...
## Modify Dataset ##########################################################################################
tnrdata <- tnrdata[ -c(5:6)] #removes columns of valve 4 data and MFC flow rate v4 
